...
alloc_proc(void) {
    ...
    memset(proc->name, 0, PROC_NAME_LEN);
     //LAB5 2012011392 : (update LAB4 steps)
    /*
	...
	proc->filesp = NULL;
    //LAB8:EXERCISE2 2012011392 HINT:need add some code to init fs in proc_struct, ...
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2012011392
    //LAB8:EXERCISE2 2012011392  HINT:how to copy the fs in parent's proc_struct?
    /*
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2012011392  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
